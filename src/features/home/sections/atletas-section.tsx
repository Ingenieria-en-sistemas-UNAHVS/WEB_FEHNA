    ...
    <section id="atletas" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {deportistas.map((d, i) => (
            <Link href={ROUTES.atletasPagina}
              key={d.id}
        ...
        <div className="text-center mt-10">
          <Link href={ROUTES.atletasPagina} className="flex items-center gap-2 mx-auto px-6 py-3 border border-white/20 text-white hover:border-accent hover:text-accent transition-all duration-200 rounded text-sm">
