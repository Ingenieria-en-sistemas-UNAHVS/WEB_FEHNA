...
export function PerformanceSummary({ athlete, performance }: { athlete: RankedAthlete; performance?: AthletePerformance }) {
  ...
  const stats = [
    ...
    { icon: Timer, label: "Mejor tiempo", value: formatTime(best.timeMs), accent: false },
